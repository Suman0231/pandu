...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-primary-100">
        ...
        <ul className="hidden md:flex items-center gap-6">
          {links.map(l => (
            <li key={l.to}>
              <NavLink
                to={l.to}
                className={({isActive}) =>
                  `px-2 py-1 rounded-md ${isActive ? 'text-white bg-primary-600' : 'text-gray-700 hover:text-primary-700'}`
                }>
                {l.label}
              </NavLink>
            </li>
          ...
          <li>
            <a
              ...
              className="inline-flex items-center gap-2 bg-green-600 text-white px-3 py-2 rounded-lg"
            >
              <Phone size={16} /> Call
            </a>
          </li>
            ...
            {links.map(l => (
              <li key={l.to}>
                <NavLink
                  ...
                  className={({isActive}) =>
                    `block px-3 py-2 rounded-md ${isActive ? 'bg-primary-600 text-white' : 'text-gray-700 hover:bg-primary-50'}`
                  }>
