...
export default function WhatsAppButton({ phone }: Props) {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-green-600 text-white shadow-lg hover:scale-110 hover:shadow-2xl transition-all duration-300 animate-float animate-glow"
    >
      <svg viewBox="0 0 32 32" width="24" height="24" aria-hidden="true" className="hover:scale-110 transition-transform duration-300">
